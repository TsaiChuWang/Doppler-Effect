...
public class WRCanvasView extends View {
    private int origin_obseverSource_X=550;
    private int origin_obseverSource_Y=900;
    private int waveSource_X=550;
    private int waveSource_Y=400;
    private int obseverSource_X=550;
    private int obseverSource_Y=900;
    private int speed=20;
    private int[][] waves=new int[100][2]; //{圓心Y座標,半徑}
    private int[][] obsevers=new int[100][2]; //{圓心Y座標,半徑}
    private int index=0;

    public WRCanvasView(Context context) {
        super(context);
    }

    public WRCanvasView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public WRCanvasView(Context context, AttributeSet attrs, int defStyle) {
